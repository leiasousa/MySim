...
public class WDMLink extends Link {
    ...
    public WDMLink(int id, int src, int dst, double delay, double weight, int wavelengths, double bw) {
        ...
        if (wavelengths < 1 || bw < 1) {
            ...
            this.availableBandwidth = new double[wavelengths];
            for (int i = 0; i < wavelengths; i++) {
     ...
     */
    public double amountBWAvailable(int wavelength) {
        if (wavelength < 0 || wavelength >= this.wavelengths) {
            throw (new IllegalArgumentException());
        } else {
     ...
     */
    public double addTraffic(int wavelength, int bw) {
     ...
     * @return the remaining available bandwidth after operation
     */
    public double removeTraffic(int wavelength, int bw) {
    ...
    public String toString() {
        String link = Long.toString(id) + ": " + Integer.toString(src) + "->" + Integer.toString(dst) + " delay: " + Double.toString(delay) + " wvls: " + Double.toString(wavelengths) + " bw: " + Double.toString(bw) + " weight:" + Double.toString(weight);
        return link;
    }
