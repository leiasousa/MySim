...
public class Main {
    ...
    public static void main(String[] args) {
        Simulator wdm;
        String usage = "Usage: EONSim simulation_file [-trace] [-verbose] [minload maxload step] seed";
        ...
        // TODO Geracao de documentacao em HTML ou PDF
        // generateHTML = Integer.parseInt(args[4]);
        // generatePDF = Integer.parseInt(args[5]);
        System.out.println("Acessando a main");
