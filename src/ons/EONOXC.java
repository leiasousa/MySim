...
/**
 * The EONOXC refers to an OXC used on a elastic optical network
 * which deals with modulation. 
 * 
 * @author rodopoulos
 */
public class EONOXC extends OXC{
	...
	// TODO Alterar as acertivas de formato de onda
	
	/**
     * Creates a new EONOXC object. All its attributes must be given
     * given by parameter.
     * 
